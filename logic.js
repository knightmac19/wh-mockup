...
const wordsArray = words.toUpperCase().match(/.{1,5}/g) ?? [];



// -------------------------- START FILE --------------------------

// array to use: wordsArray
  ...
  const removeWordsWithLettersInWrongPosition = (position, arr, verboten) => {
    if (verboten.length == 0) {
      ...
      // console.log('\n');
      // console.log(`no forbidden letters for position ${position + 1}`);
      return arr;
    } else {
      for (var i = 0; i < arr.length; i++) {
...
// ---------------------------------------- SET VERBOTEN AND LETTERS HERE ----------------------------------------
  ...
  // const lettersThatCantBeUsed = '';
  // const mustBeUsed = '';
  
  // const positionOneCantBe = '';
  // const positionTwoCantBe = '';
  // const positionThreeCantBe = '';
  // const positionFourCantBe = '';
  // const positionFiveCantBe = '';
...
// ---------------------------------------- SET VERBOTEN AND LETTERS HERE ----------------------------------------
  ...
  const randomNextGuess = (arr) => {
    ...
    if (arr.length < 30) {
      ...
      console.log(`${randomValue} recommended for next guess`);
      console.log('\n');
      return randomValue;
